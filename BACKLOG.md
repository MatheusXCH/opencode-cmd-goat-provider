...
### 2. Graceful catalog discovery failure
...
Status: technically feasible; API stability decision required before release.
...
- Add fixtures for all response shapes used by the UI.

## Deferred

### 3. Push/PR CI

Status: rejected. Tests continue to run in the Release workflow only.

### 4. Enforced zero data retention (ZDR)
